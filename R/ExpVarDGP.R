...
#' \insertCite{dufour2010exact;textual}{PredictiveDGP} and \insertCite{coudin2009finite;textual}{PredictiveDGP}. The initial value of the process \eqn{x} is generated by \eqn{x_0=\frac{w_0}{\sqrt{1-\theta^2}}}, 
...
#' @keywords Endogeneity persistency normal exponential-variance
#' @import pracma
#' @export 
#' @examples
#' ExpVarDGP(n=50, beta=0.5, theta=0.999, rho=0.9)
#' @references
#' \insertAllCited{}
...
ExpVarDGP <- function(n, beta, theta, rho){
	...
	#Generate empty variables for the errors terms and their respective standard deviations
	stdev <- rep(0, times=n)
	eps <- rep(0, times=n)

	#Generate the error terms with exponential variance for the predictive regression, and the standard normal errors for the regressor.	
	for(l in 1:n){
