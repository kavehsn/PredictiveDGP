...
#' \insertCite{dufour2010exact;textual}{Rdpack} and \insertCite{coudin2009finite;textual}{Rdpack}. The initial value of the process \eqn{x} is generated by \eqn{x_0=\frac{w_0}{\sqrt{1-\theta^2}}}, 
